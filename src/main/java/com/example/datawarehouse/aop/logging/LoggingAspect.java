package com.example.datawarehouse.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        "within(com.example.datawarehouse.repository..*)" +
        " || within(com.example.datawarehouse.service..*)" +
        " || within(com.example.datawarehouse.resource..*)"
    )
